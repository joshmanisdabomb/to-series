...
# Introduction
The {{"template": "introduction", "description": "an explosive device"}}. It can be filled with 1 {{"of": "minecraft:block / minecraft:tnt"}}, 1 {{"of": "minecraft:item / to_stars:enriched_uranium_nugget"}} and between 1 and 45 {{"of": "minecraft:item / to_stars:enriched_uranium"}} to create a {{"of": "to_base:concept / to_stars:nuclear_explosion"}}.
...
- 1 {{"of": "minecraft:item / to_stars:enriched_uranium_nugget"}}
- Between 1 and 45 {{"of": "minecraft:item / to_stars:enriched_uranium"}}, or between 1 and 5 {{"of": "minecraft:block / to_stars:enriched_uranium_block", "plural": true}}
...
The explosion strength is determined by the amount of {{"of": "minecraft:item / to_stars:enriched_uranium"}} added to the {{"of": "self"}}, with each additional unit giving diminishing returns.

The formula for explosion strength is: `20 + floor(sqrt((uranium - 1) / 44) * 120)`

See the {{"of": "to_base:concept / to_stars:nuclear_explosion"}} page for what explosion strength means in block and entity damage.
