---
name: article
description: Writing and editing data-driven wiki articles for the To mod series (index.json, en_us/index.md, factsheet.json). Use when creating or modifying any article under <modId>/common/src/main/templates/wiki/, adding wiki entries for new mods, items, blocks, concepts, versions, or checking that an existing article follows mod conventions.
---
