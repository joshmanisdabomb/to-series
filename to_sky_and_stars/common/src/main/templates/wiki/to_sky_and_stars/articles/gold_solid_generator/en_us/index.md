...
When heat is stored in a {{"of": "self"}} but no more fuel is remaining, the temperature cools down at a rate of 0.6% per tick, until it reaches 100°C. After this, the temperature is instantly reset to 0°C.
