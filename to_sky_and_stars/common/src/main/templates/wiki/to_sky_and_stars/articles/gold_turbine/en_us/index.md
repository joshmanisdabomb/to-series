...
The {{"template": "introduction", "description": "an energy-generating block"}}. Crafted using a {{"of": "to_base:tag / to_sky_and_stars:machine/enclosure", "text": "gold tier enclosure"}}, it converts the kinetic energy of {{"of": "minecraft:block / to_sky_and_stars:rotor_blades"}} into {{"of": "to_base:concept / to_base:to_energy"}} at a higher rate than a {{"of": "minecraft:block / to_sky_and_stars:copper_turbine"}}.
