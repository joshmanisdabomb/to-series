package net.jidb.to.base.neoforge.data.model
...
class ExtendedBlockModelGenerators(val models: BlockModelGenerators) {

    fun createFullRotatedVariantBlock(block: Block) {
