...
open class ScreenLibrary(modid: String) : SimpleLibrary<ScreenLibrary.ScreenEntry<*, *>>(modid) {

    override fun afterBuild(entry: Library<ScreenEntry<*, *>, ScreenEntry<*, *>>.LibraryEntry<out ScreenEntry<*, *>, out ScreenEntry<*, *>>) = entry.value.register()
