...
/**
 * A record of the data components each item was registered with, kept so that an item's default component value can be read back after the fact.
 ...
 *
 * The records are written by [net.jidb.to.base.mixin.ItemMixin] and [net.jidb.to.base.mixin.ItemPropertiesMixin] as items are constructed, which is why this lives outside the generator packages that read it: those are stripped from a built jar, and this is not.
 *
 * @since 1.0.0
 */
